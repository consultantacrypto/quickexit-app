                    ...
                    <>
                      ...
                      <div>
                        ...
                        <input
                          type="number"
                          onChange={(e) =>
                            updateRequirement("an_minim", e.target.value)
                          }
                          placeholder="Ex: 2021"
                          className={inputBase}
                        />
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          onChange={(e) =>
                            updateRequirement("culoare", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          onChange={(e) =>
                            updateRequirement("locatie", e.target.value)
                          }
                    ...
                    <>
                      <div className="md:col-span-2">
                        ...
                        <input
                          type="text"
                          onChange={(e) =>
                            updateRequirement("tip_proprietate", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <input
                          type="number"
                          onChange={(e) =>
                            updateRequirement("suprafata_min", e.target.value)
                          }
                          placeholder="Ex: 120"
                          className={inputBase}
                        />
                    ...
                    <>
                      <div className="md:col-span-2">
                        ...
                        <input
                          type="text"
                          onChange={(e) =>
                            updateRequirement("brand_model", e.target.value)
                          }
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <input
                          type="number"
                          onChange={(e) =>
                            updateRequirement("vechime_min", e.target.value)
                          }
                          placeholder="Ex: 3"
                          className={inputBase}
                        />
                      ...
                      <div className="md:col-span-3">
                        ...
                        <input
                          type="text"
                          onChange={(e) =>
                            updateRequirement("conditii_achizitie", e.target.value)
                          }
                    ...
                    <>
                      <div className="md:col-span-2">
                        ...
                        <input
                          type="text"
                          onChange={(e) =>
                            updateRequirement("model_specs", e.target.value)
                          }
