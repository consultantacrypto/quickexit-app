  ...
  return (
    <div className="min-h-screen bg-[#F7F4EC] pt-8 pb-20 font-sans text-black selection:bg-black selection:text-[#FFD100]">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="mb-10">
          <Link href="/" className="text-[11px] font-black uppercase tracking-[0.3em] italic border-b-[3px] border-black pb-1 hover:text-[#FFD100] hover:border-[#FFD100] transition-all">
            ← Înapoi Acasă
          </Link>
          ...
          <div className="mt-7 bg-black text-white border-[3px] border-black rounded-[2rem] p-6 md:p-8 shadow-[8px_8px_0_0_rgba(255,209,0,1)]">
            ...
            <h1 className="text-3xl md:text-5xl font-black uppercase italic tracking-tighter leading-[0.95] mb-4">
              Cumpărători pregătiți <span className="text-[#FFD100]">pentru oportunități reale</span>
            </h1>
            <p className="text-sm md:text-base font-bold text-neutral-200 max-w-3xl italic leading-relaxed">
              Vezi cererile active ale cumpărătorilor care caută active sub prețul pieței.
            </p>
            <Link href="/posteaza-cerere" className="mt-6 inline-block w-full md:w-auto bg-[#FFD100] text-black px-7 py-4 rounded-xl border-[3px] border-black font-black uppercase tracking-widest text-xs italic shadow-[4px_4px_0_0_rgba(0,0,0,1)] hover:bg-white transition-colors text-center">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {filteredBuyers.map((buyer) => (
              <div key={buyer.id} className="bg-white border-[3px] border-black rounded-[2rem] p-6 md:p-7 shadow-[6px_6px_0_0_rgba(255,209,0,1)] hover:-translate-y-1 transition-all flex flex-col justify-between group">
                <div>
                  <div className="flex justify-between items-start mb-6">
                    <span className="bg-[#FFD100] text-black px-3 py-2 rounded-lg text-[11px] font-black uppercase tracking-widest italic border-2 border-black">
                      {buyer.budget >= 100000 ? "Capital verificat" : "Capital disponibil"}
                    </span>
                    <span className="text-2xl opacity-70 group-hover:opacity-100 transition-all">💰</span>
                  </div>
          ...
          <div className="text-center py-20 bg-white border-[3px] border-black rounded-[2rem] shadow-[7px_7px_0_0_rgba(255,209,0,1)]">
            ...
            <h3 className="text-2xl md:text-3xl font-black uppercase italic mb-3">Nu există cereri active momentan.</h3>
            <p className="text-neutral-700 font-bold mb-8">Revino în curând sau publică prima ta cerere de cumpărare.</p>
            <Link href="/posteaza-cerere" className="inline-block w-full sm:w-auto bg-black text-[#FFD100] px-8 py-4 rounded-xl border-[3px] border-black font-black uppercase text-xs italic shadow-[4px_4px_0_0_rgba(255,209,0,1)]">
