    ...
    <div className="min-h-screen bg-[#F7F4EC] pt-16 pb-20 font-sans text-black antialiased selection:bg-black selection:text-[#FFD100]">
      <div className="max-w-7xl mx-auto px-4 md:px-8 overflow-x-hidden">
        <section className="mb-12 border-[3px] border-black bg-black text-white rounded-[2rem] px-5 md:px-8 py-7 md:py-9 shadow-[8px_8px_0_0_rgba(255,209,0,1)]">
          <p className="text-xs font-black uppercase tracking-[0.2em] text-[#FFD100] mb-3">Tarife Quick Exit</p>
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div className="max-w-3xl">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase italic tracking-tight leading-tight">
                Alege viteza <span className="inline-block bg-[#FFD100] text-black px-2 py-1 rounded-md">de vânzare</span>
              </h1>
              <p className="mt-4 text-sm md:text-base text-neutral-200 leading-relaxed">
                Pachetul stabilește durata, prioritatea și metoda de expunere a anunțului.
              </p>
            </div>
        ...
        <div className="mb-8 border-b-2 border-black pb-2">
          <h2 className="text-xl font-black uppercase italic tracking-tight text-neutral-700">Pachete pentru publicare anunț</h2>
        </div>
            ...
            >
              <div>
                <div className="flex justify-between items-start mb-5">
                  <span className={`px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-widest border-2 border-black ${pkg.badge}`}>{pkg.tag}</span>
                  {pkg.isRecommended && (
                ...
                <h3 className="text-3xl font-black uppercase italic tracking-tight mb-2">{pkg.publicName}</h3>
                <p className="text-xs font-bold text-neutral-700 mb-4">{pkg.benefit}</p>
                <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-6">Durată: {pkg.duration}</p>

                <div className="space-y-3 mb-6">
                  {pkg.features.map((feat) => (
                    <div key={feat} className="flex items-start gap-2.5 font-bold text-xs text-neutral-700">
                      <span className="text-[#FFD100] text-lg leading-none">✓</span> {feat}
                    </div>
                  ))}
                </div>
                <p className="text-xs font-semibold text-neutral-700">{pkg.bestFor}</p>
              </div>
        ...
        <div className="mb-8 border-b-2 border-black pb-2">
          <h2 className="text-xl font-black uppercase italic tracking-tight text-neutral-700">Licitație rapidă</h2>
        </div>
        ...
        <div className="bg-[#FFD100] border-[3px] border-black rounded-[2rem] p-6 md:p-10 shadow-[10px_10px_0_0_rgba(0,0,0,1)] mb-14 relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <span className="bg-black text-[#FFD100] px-3 py-1 rounded text-xs font-black uppercase tracking-widest italic mb-4 inline-block">Lichiditate imediată</span>
              <h2 className="text-4xl md:text-6xl font-black uppercase italic tracking-tighter leading-[0.85] mb-4 text-black">
                Licitație <br /> <span className="text-white drop-shadow-[2px_2px_0_rgba(0,0,0,1)]">Rapidă</span>
              </h2>
              ...
              <ul className="space-y-3 mb-4">
                <li className="flex items-center gap-2 font-black uppercase italic text-xs text-black">Competiție în timp real între investitori</li>
                <li className="flex items-center gap-2 font-black uppercase italic text-xs text-black">Expunere accelerată către cumpărători pregătiți</li>
                <li className="flex items-center gap-2 font-black uppercase italic text-xs text-black">Cronometru vizual pe pagina activului</li>
              </ul>
            </div>
        ...
        <div className="mb-8 border-b-2 border-black pb-2">
          <h2 className="text-xl font-black uppercase italic tracking-tight text-neutral-700">Servicii cumpărători</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="bg-white border-[3px] border-black p-6 rounded-[1.5rem] shadow-[6px_6px_0_0_rgba(0,0,0,1)]">
            ...
            <p className="text-xs font-bold text-neutral-700 uppercase tracking-widest mb-6 italic">Anunță capital disponibil pentru achiziții urgente sub preț.</p>
            <p className="text-3xl font-black italic tracking-tighter mb-6">99 RON</p>
            <Link href="/posteaza-cerere" className="block w-full border-[3px] border-black py-3 rounded-lg font-black uppercase tracking-widest text-xs italic text-center hover:bg-black hover:text-[#FFD100] transition-all">Postează bugetul</Link>
          </div>

          <div className="bg-white border-[3px] border-black p-6 rounded-[1.5rem] shadow-[6px_6px_0_0_rgba(0,0,0,1)]">
            <h3 className="text-2xl font-black uppercase italic tracking-tight mb-2">Ofertă Guest</h3>
            <p className="text-xs font-bold text-neutral-700 uppercase tracking-widest mb-6 italic">Trimite o ofertă directă fără a avea un cont verificat.</p>
            <p className="text-3xl font-black italic tracking-tighter mb-6">49 RON</p>
            <Link href="/capital-disponibil" className="block w-full border-[3px] border-black py-3 rounded-lg font-black uppercase tracking-widest text-xs italic text-center hover:bg-black hover:text-[#FFD100] transition-all">Vinde-i activul tău</Link>
          </div>
        </div>
        ...
        <section className="mb-8 bg-[#FDFCF8] border-[3px] border-black rounded-[1.5rem] p-6 md:p-8 shadow-[6px_6px_0_0_rgba(255,209,0,0.85)]">
          <h2 className="text-2xl font-black uppercase italic tracking-tight mb-5">Cum aleg pachetul potrivit?</h2>
          <div className="space-y-3 text-sm text-neutral-700">
            <p><span className="font-black text-black">Dacă nu te grăbești:</span> Expunere Maximă.</p>
            <p><span className="font-black text-black">Dacă vrei echilibru preț/viteză:</span> Vânzare Rapidă.</p>
            <p><span className="font-black text-black">Dacă ai nevoie de lichiditate imediată:</span> Vânzare Urgentă sau Licitație Rapidă.</p>
          </div>
        </section>

        <p className="text-xs text-neutral-600 mb-4">
          Plata activează publicarea și expunerea anunțului. Nu garantează vânzarea activului.
        </p>
      </div>
    </div>
  );
