      ...
      <div className="p-6 flex flex-col flex-grow bg-white">
        <div className="flex justify-between items-start mb-4 gap-4">
          ...
          <button
            ...
            aria-label={
              isFavorite
                ? `Elimină „${title}” din favorite`
                : `Adaugă „${title}” la favorite`
            }
            aria-pressed={isFavorite}
            className="bg-gray-50 border-2 border-black p-2 rounded-xl hover:bg-[#FFD100] transition-colors shrink-0"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill={isFavorite ? "black" : "none"} viewBox="0 0 24 24" strokeWidth={2.5} stroke="black" className="w-5 h-5" aria-hidden>
